...
/*   Updated: 2025/11/15 20:42:27 by yosherau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (game->map.map[(int)game->player.y_pos][(int)(game->player.x_pos
		- game->player.plane_x * 0.11)] == '0')
		game->player.x_pos -= game->player.plane_x * 0.1;
	if (game->map.map[(int)(game->player.y_pos
			- game->player.plane_y * 0.11)][(int)(game->player.x_pos)] == '0')
